...
if($site=="smslive"){
$api = file_get_contents("https://smslive.pro/stubs/handler_api.php?api_key=$api_key&action=getNumber&service=$app&country=$country");
$explode = explode(":",$api);
$idnumber = $explode[1];
$number = $explode[2];
if($number==null){
...
if($site=="smslive"){
$api = file_get_contents("https://smslive.pro/stubs/handler_api.php?action=getStatus&api_key=$api_key&id=$idnumber");
$ex_api= explode(":",$api);
$code = $ex_api[1];
$agen = 1;
if($code==null){
...
if($site=="smslive"){
$api = file_get_contents("https://smslive.pro/stubs/handler_api.php?api_key=$api_key&action=setStatus&api_key=$api_key&id=$idnumber&status=8");
$status=200;
$Location  = "smslive.pro";
}
if($site=="man"){
...
if($site=="smslive"){
$api = json_decode(file_get_contents("https://smslive.pro/stubs/handler_api.php?api_key=$api_key&action=getPrices&service=$app&country=$country"),1);
