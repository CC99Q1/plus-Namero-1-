...
file_put_contents('data/id/start.json', json_encode($array));
}
function Save($array){
...
$admins = json_decode(file_get_contents('data/id/start.json'),true);
...
$bot="pls";  #اسم الملف الي مسويه بالاستضافه
